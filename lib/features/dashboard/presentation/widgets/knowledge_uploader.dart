...
class _KnowledgeUploaderState extends ConsumerState<KnowledgeUploader> {
  ...
  Future<void> _pickAndUpload() async {
    ...
    if (uploadState.error != null) {
      _showSnack(uploadState.error!, AppColors.error, Colors.white);
    } else {
      ...
      data: (sources) {
        if (sources.isEmpty) {
          return Container(
            ...
            decoration: BoxDecoration(border: Border.all(color: AppColors.borderGlass)),
            child: Center(
              child: Text(
        ...
        child: Center(
          child: isUploading
              ...
              : Column(
                  ...
                  children: [
                    const Icon(Icons.upload_file_outlined, color: AppColors.primary, size: 26),
      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            ...
            border: const OutlineInputBorder(borderRadius: BorderRadius.zero, borderSide: BorderSide(color: AppColors.borderGlass)),
            enabledBorder: const OutlineInputBorder(borderRadius: BorderRadius.zero, borderSide: BorderSide(color: AppColors.borderGlass)),
...
class _TypeIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Icon(icon, size: 15, color: AppColors.primary);
  }
}
